...
export const MOODS: Mood[] = [
  ...
  {
    key: 'focused',
    aliases: ['concentrado', 'concentrada', 'trabajando'],
  ...
  {
    key: 'hungover',
    aliases: ['guayabo', 'resaca', 'crudo', 'cruda'],
